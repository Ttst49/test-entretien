 ...
 */
final class Version20240422081349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_clinique_depots (id INT NOT NULL, titre VARCHAR(255) NOT NULL, description TEXT NOT NULL, date_creation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE demande_clinique_reponses (id INT NOT NULL, depot_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description TEXT NOT NULL, date_creation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type INT NOT NULL, PRIMARY KEY(id))');
